...
urlpatterns = [
    ...
    path('get_discipline/<int:id>', views_discipline.get_discipline),
    path('get_game/<int:id>', views_game.get_game),
    path('get_season/<int:id>', views_season.get_season),
    path('seasons_moderator', views_season.get_all_seasons_moderator),
    path('get_all_games', views_game.get_all_games),
    path('games/<str:name>', views_game.discipline_games),
    path('add_game', views_game.AddGame.as_view()),
    ...
    path('moderator/articles/<str:username>', views_article.get_articles_for_section_moderator),
    ...
    path('moderator/delete/<int:article_id>/', views_article.DeleteArticle.as_view(), name='deletepost'),
    ...
    path('moderator/edit_game/<int:game_id>', views_game.EditGame.as_view()),
    path('moderator/delete_season/<int:season_id>', views_season.DeleteSeason.as_view()),
    path('moderator/edit_season/<int:season_id>', views_season.EditSeason.as_view()),
    path('moderator/delete_match/<int:pk>', views_match.DeleteMatch.as_view()),
    path('moderator/edit_match/<int:match_id>', views_match.EditMatch.as_view()),
    path('edit/seasondetail/<int:pk>/', views_season.SeasonDetail.as_view()),
    path('edit/matchdetail/<int:pk>/', views_match.MatchDetail.as_view()),
    path('edit/disdetail/<int:pk>/', views_discipline.DisciplineDetail.as_view()),
    path('edit/gamedetail/<int:pk>/', views_game.GameDetail.as_view()),
    path('seasons', views_season.get_seasons),
    path('matches', views_match.get_matches),
    path('deletecom/<int:comment_id>', views_comment.DeleteComment.as_view()),
