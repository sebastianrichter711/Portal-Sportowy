...
urlpatterns = [
    ...
    path('moderator/delete_season/<int:pk>', views_season.DeleteSeason.as_view()),
    path('moderator/edit_season/<int:pk>', views_season.EditSeason.as_view()),
    path('moderator/delete_match/<int:pk>', views_match.DeleteMatch.as_view()),
    path('moderator/edit_match/<int:pk>', views_match.EditMatch.as_view()),
    ...
    path('matches', views_match.MatchList.as_view()),
